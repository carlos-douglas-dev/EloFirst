...
import com.example.android.currencyconverter.api.Endpoint
import com.example.android.currencyconverter.util.NetworkUtils
...
class MainActivity : AppCompatActivity() {
    ...
    fun convertMoney(){
        ...
        endpoint.getCurrencyRate(spFrom.selectedItem.toString(), spTo.selectedItem.toString()).enqueue(object : retrofit2.Callback<JsonObject>{
